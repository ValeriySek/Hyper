...
import com.android.hyper.feature.MainActivity
...
class Authorization @Inject constructor(
    ...
    fun startPhoneNumberVerification(phoneNumber: String) {
        Log.i("TAGG", "startPhoneNumberVerification credential")
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                ...
                //     user action.
                Log.i("TAGG", "onVerificationCompleted:$credential")
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                Log.i("TAGG", "onVerificationFailed", e)
            ...
            override fun onCodeSent(
                ...
                Log.i("TAGG", "onCodeSent:$verificationId")
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    Log.i("TAGG", "signInWithCredential:failure", task.exception)
